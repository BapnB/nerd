...
local function RefreshGUI()
	...
	for _, Obj in pairs(GetTable()) do
		...
		SB.frame.Right:SetText('( |cffff0000KEY|r: '..Obj.key..' / |cffff0000ID|r: '..Obj.id..' / |cffff0000Dist|r: '..distance..' )') --|cffff0000Health|r: '..Health..' / 
		SB.frame:SetScript('OnMouseDown', function() TargetUnit(Obj.key) TargetUnit(Obj.name) end)
		SB:SetValue(Health)
		offset = offset -18
	end
end
