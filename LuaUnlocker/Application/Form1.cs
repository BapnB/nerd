...
namespace WindowsForms
{
    public partial class Form1 : Form
    {
        ...
        private void BypasAntiCheat01(bool status, IntPtr wHandle)
        {
            ...
            var CreateRemoteThreadPatchOffset = (long)GetProcAddress(GetModuleHandle("kernel32.dll"), "BaseDumpAppcompatCacheWorker") + 0x250;
        ...
        private void btnInject_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var process = System.Diagnostics.Process.GetProcessesByName("UWow-64").FirstOrDefault();

                if (process == null)
                    process = System.Diagnostics.Process.GetProcessesByName("Wow-64").FirstOrDefault();
